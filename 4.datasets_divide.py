...
root = '/home/qianxianserver/data/cxx/breast_all/breast/视频-2021-2/2021_breast_three_classification_zk2/Mix_Data'
root_pure = '/home/qianxianserver/data/cxx/breast_all/breast/视频-2021-2/2021_breast_three_classification_zk2/Pure'
...
if not os.path.exists(root + '/New'):
    ...
    os.mkdir(root + '/New/Train/H')    
    os.mkdir(root + '/New/Test')    
    os.mkdir(root + '/New/Test/C')    
    os.mkdir(root + '/New/Test/N')    
    os.mkdir(root + '/New/Test/H')    
    
    os.mkdir(root_pure + '/New')    
    os.mkdir(root_pure + '/New/Train')    
    os.mkdir(root_pure + '/New/Train/C')    
    os.mkdir(root_pure + '/New/Train/N')    
    os.mkdir(root_pure + '/New/Train/H')    
    os.mkdir(root_pure + '/New/Test')    
    os.mkdir(root_pure + '/New/Test/C')    
    os.mkdir(root_pure + '/New/Test/N')    
    os.mkdir(root_pure + '/New/Test/H')    
    ...
    for item_c in new_test_c_path:
        ...
        dir_copyTree(root_pure + '/C/' + item_c+'_c', root_pure + '/New/Test/C/' + item_c)
        
        dir_copyTree(root + '/H/' + item_c+'_c', root + '/New/Test/H/' + item_c+'_c')
        dir_copyTree(root + '/H/' + item_c+'_c', root_pure + '/New/Test/H/' + item_c+'_c')

    for item_n in new_test_n_path:
        dir_copyTree(root + '/N/' + item_n, root + '/New/Test/N/' + item_n)
        dir_copyTree(root_pure + '/N/' + item_n+'_n', root_pure + '/New/Test/N/' + item_n)

        dir_copyTree(root + '/H/' + item_n+'_n', root + '/New/Test/H/' + item_n+'_n')
        dir_copyTree(root + '/H/' + item_n+'_n', root_pure + '/New/Test/H/' + item_n+'_n')
    

    for item_c in new_train_c_path:
        dir_copyTree(root + '/C/' + item_c, root + '/New/Train/C/' + item_c)
        dir_copyTree(root_pure + '/C/' + item_c + '_c', root_pure + '/New/Train/C/' + item_c)

        dir_copyTree(root + '/H/' + item_c+'_c', root + '/New/Train/H/' + item_c+'_c')
        dir_copyTree(root + '/H/' + item_c+'_c', root_pure + '/New/Train/H/' + item_c+'_c')

        
    for item_n in new_train_n_path:
        dir_copyTree(root + '/N/' + item_n, root + '/New/Train/N/' + item_n)
        dir_copyTree(root_pure + '/N/' + item_n + '_n', root_pure + '/New/Train/N/' + item_n)

        dir_copyTree(root + '/H/' + item_n+'_n', root + '/New/Train/H/' + item_n+'_n')
        dir_copyTree(root + '/H/' + item_n+'_n', root_pure + '/New/Train/H/' + item_n+'_n')
